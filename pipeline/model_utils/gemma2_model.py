...
GEMMA_REFUSAL_TOKS = [
    ...
    11649,
    126078,
]  # [newline, 'I', 'cannot', 'As', 'Sorry', 'apologize', 'unable']
...
class GemmaModel(ModelBase):
    def _load_model(self, model_path, dtype=torch.bfloat16):
        model = LocalGemma2ForCausalLM.from_pretrained(
            ...
            torch_dtype=dtype,
            device_map="auto",
            preset="auto",  # or "memory" or "memory_extreme" depending on your needs
        ).eval()
    ...
    def check_model_weights(self):
        for name, param in self.model.named_parameters():
            if torch.isnan(param).any():
                ...
                print("NaN positions:", torch.nonzero(torch.isnan(param)))
